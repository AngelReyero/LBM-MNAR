...
import numpy as np
import yaml 
from fcts.utils import load_objects_from_yaml, reparametrized_expanded_params
...
indices_p = loaded_parameters['indices_p']
indices_n = loaded_parameters['indices_n']
indices_zeros = loaded_parameters['indices_zeros']
...
def return_all_params(filepath): 
    ...
    nu_a = loaded_parameters['nu_a']
    rho_a = loaded_parameters['rho_a']
    nu_b = loaded_parameters['nu_b']
    rho_b = loaded_parameters['rho_b']
    nu_p = loaded_parameters['nu_p']
    rho_p = loaded_parameters['rho_p']
    nu_q = loaded_parameters['nu_q']
    rho_q = loaded_parameters['rho_q']
    tau_1 = loaded_parameters['tau_1']
    tau_2 = loaded_parameters['tau_2']
    mu_un = loaded_parameters['mu_un']
    sigma_sq_a =loaded_parameters['sigma_sq_a']
    sigma_sq_b =loaded_parameters['sigma_sq_b']
    sigma_sq_p =loaded_parameters['sigma_sq_p']
    sigma_sq_q =loaded_parameters['sigma_sq_q']
    alpha_1 = loaded_parameters['alpha_1']
    alpha_2 = loaded_parameters['alpha_2']
    pi =loaded_parameters['pi']
    return nu_a,rho_a,nu_b,rho_b,nu_p,rho_p,nu_q,rho_q,tau_1,tau_2,mu_un,sigma_sq_a,sigma_sq_b,sigma_sq_p,sigma_sq_q,alpha_1,alpha_2,pi
...
def criteria(filepath):
        ###MODIFIER ICI pour avoir juste les variables 
